...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    /**
     * Return the color of the magnitude_circle based on the magnitude value
     */
    private int getMagnitudeColor(double magnitude) {
        ...
        return ContextCompat.getColor(getContext(), magnitudeColorResourceId);//converting color to int value
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //To break location string into 2 parts - primary location and location offset
        String fullLocation = currentEarthquake.getLocation();
        String locationOffset = "", primaryLocation = "";
        int ind = fullLocation.indexOf("of");
        if(ind == -1){
            ...
            primaryLocation=fullLocation.substring(ind+2);
            locationOffset=fullLocation.substring(0,ind+2);
        }
